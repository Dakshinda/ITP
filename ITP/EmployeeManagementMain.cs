...
namespace ITP
{
    ...
    public partial class EmployeeManagementMain : Form
    {
        ...
        private void btnSalaryPayment_Click(object sender, EventArgs e)
        {
            ActivateButton(sender, RGBColors.color2);
            OpenChildForm(new SalaryPayment());
        }
        ...
        private void Reset()
        {
            ...
            lblTitleChildForm.Text = "Employee Management";
        }
